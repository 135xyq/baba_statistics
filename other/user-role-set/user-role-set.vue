  ...
  <view class="container">
    <view class="main">
      ...
      <view class="section">
        ...
        <view class="section__content">
          <view class="setting-item" v-for="(item) in currentRoleModuleConfig" :key="item.key">
      ...
      <view class="section">
        ...
        <view class="section__content">
          <view class="setting-item" v-for="(item) in currentRoleTabbarConfig" :key="item.key">
            <text class="setting-item__label">{{ item.name }}</text>
            <u-switch v-model="item.show" activeColor="#d81e06" />
          </view>
        </view>
